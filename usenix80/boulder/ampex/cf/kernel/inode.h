...
struct {			/* contiguous file access to addr array */
	int	i_cflag,	/* == ICFLAG for contiguous files */
		i_cdev,		/* char major-minor device */
		i_bdev;		/* block major-minor device */
	long	i_cbase,
		i_clast;
	int	i_cjunk;
} ;
...
#define ICFLAG	-1		/* contig. file, in i_cflag field */

/* modes */
#define	IALLOC	0100000		/* file is used */
#define	IFMT	060000		/* type of file */
#define		IFDIR	040000	/* directory */
#define		IFCHR	020000	/* character special or contiguous file */
