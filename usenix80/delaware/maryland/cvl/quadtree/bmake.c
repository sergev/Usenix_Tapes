...
int ipts,jpts,nodes,offset,gx,gy,error,size,words,bpts ;
...
node[1] = lev ;                         /* level in tree      */
node[2] = bpts ;                        /* black pts inquadr  */
