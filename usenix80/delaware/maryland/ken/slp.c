...
loop:
	spl6();
	n = -1;
	for(rp = &proc[0]; rp <= lastproc; rp++) /* rlg */
...
retry:
	...
	rpp->p_time = 0;
	rpp->p_sig = 0; /* out out damn spot */ /* CAC -- protect child */
