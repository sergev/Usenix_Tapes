...
int	flslvl;
char *stringbuf;
char *pass0 "/lib/mc/mc0";
char *pass1 "/lib/mc/mc1";
char *pass2 "/lib/mc/mc2";
char *asmblr "/lib/mc/mcca";
char *linkr "/lib/mc/calink";
char *pref;
char *pref4 "/lib/mc/mcrt4.s";
char *pref8 "/lib/mc/mcrt8.s";
char *pref12 "/lib/mc/mcrt12.s";
char *pref16 "/lib/mc/mcrt16.s";
char *pref20 "/lib/mc/mcrt20.s";
char *pref24 "/lib/mc/mcrt24.s";
char *pref28 "/lib/mc/mcrt28.s";
char *pref32 "/lib/mc/mcrt32.s";
char *csv   "/lib/mc/csv.s";
char *mul   "/lib/mc/mult.s";
char *divide "/lib/mc/div.s";
char *modulus "/lib/mc/mod.s";

main(argc, argv)
char *argv[]; {
	char *t;
	int nc, nl, i, j, c, f20, nxo;
	int mult, div, mod, status;
	int dexit();
	...
	while(++i < argc) {
		if(*argv[i] == '-')
			switch (argv[i][1]) {
				...
				case 'b':	/* ca output format */
					bflag++;
					break;

				case 'f':
					printf("No floating point\n");
					exit();
