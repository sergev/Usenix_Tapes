 ...
 * creat system call
 *
 * Purdue fix added 03/08/78; see Unix News 2.5
 */
creat()
{
	register *ip;
...
nap()
{
	...
	if (number_napping < MAX_NAPPING) {
		number_napping++;
		timeout(hitme, u.u_procp, u.u_ar0[R0]);
