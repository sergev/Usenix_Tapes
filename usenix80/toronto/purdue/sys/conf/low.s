...
. = 52^.	/ click addr's of low and high bad mem, 0 if good.
.globl _meml, _memh	/ see ken/main.c
_meml:	0
_memh:	0
...
.globl	_midaint
daio:	jsr	r0,call; _midaint

.globl	_midmrint
mpin:	jsr	r0,call; _midmrint
