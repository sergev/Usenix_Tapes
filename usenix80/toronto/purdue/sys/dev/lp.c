...
int	lphangs; /* kludge!! number of times our interface has hung */
int	lphngs;  /* kludge - nz if watchdog active */
struct {
	int lpsr;
	int lpbuf;
};
...
/*  kludge code for our Centronics which looses interrupts */
	if(lphngs == 0)
		timeout(&lpck,0,900);	/* start interrupt watchdog */
		lphngs++;
/* .......................................................... */
...
/*  Kludge code to force lp interface to interrupt again */
lpck()
{
	if(LPADDR->lpsr == 0300) {
		LPADDR->lpsr = 0300; /* kick lp interface in side */
		lphangs++;
	}
	timeout(&lpck,0,3600);	/* go away for a minute */
}
/* .................................................... */
...
{
	lpcanon(FORM);
	lpoutput(0); /* kludge for Houston printer  hdwe problem */
	lp11.flag = 0;
}
