/*
 *
 * And.c    And's two files and places the result in the destination
 *      usage : and infile in2file outfile
...
char    *argv[];
{
        ...
        while( --argc > 0 )
        {
                ...
                andfile(infile, in2file, outfile);
...
usage()
{
                erreur("usage: and infile in2file outfile ","");
}
