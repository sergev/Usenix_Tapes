/*
 *
 * Xor.c    Xor's two files and places the result in the destination
 *      usage : xor  infile in2file outfile
...
char    *argv[];
{
        ...
        while( --argc > 0 )
        {
                ...
                xorfile(infile, in2file, outfile);
...
usage()
{
                erreur("usage: xor infile in2file outfile ","");
}
