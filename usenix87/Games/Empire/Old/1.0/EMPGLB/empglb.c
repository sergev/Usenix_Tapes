...
/* parametric goodies */
int	privuid = 101;		/* uid of priv user */
char	privname[] = "Bob";		/* name of priv user */
char	privlog[] = "bob";		/* logname of priv user */
...
int	m_m_p_d = 1000*1;		/* max mins of play per day (per country) */
