...
*/  0,   0,         0,     &(((struct shpstr *)0)->shp_own),    0,    0,   0,  0, { 1, 1, 1, 1},       "owner",
    0,   0,         0,     &(((struct shpstr *)0)->shp_type),   0,    0,   0,  0, { 1, 1, 1, 1},       "designation",
    0,   0,         0,     &(((struct shpstr *)0)->shp_effc),   0,    0,   0,  0, { 1, 1, 1, 1},       "efficiency",
