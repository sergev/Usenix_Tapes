/*
 * Phantasia 3.3 -- Interterminal fantasy game
 *
 * Edward A. Estes
 * AT&T Teletype Corporation, July 9, 1985
 */
 ...
 *
 * AT&T and AT&T Teletype Corporation are in no way connected with this
 * game.
 */
...
#endif
    mvaddstr(21,24,"Do you have a character to run? ");
    ch = getans("NY", FALSE);
    if (ch == 'Y')
