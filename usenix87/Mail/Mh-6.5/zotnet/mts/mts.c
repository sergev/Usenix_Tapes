...
static char *mtstailor = "/usr/local/lib/mh/mtstailor";
...
#ifdef	MF
char   *umincproc = "/usr/local/lib/mh/uminc";
#else	MF
char   *umincproc = NULL;
#endif	MF
...
char   *Okhosts = "/usr/local/lib/mh/Rmail.OkHosts";
char   *Okdests = "/usr/local/lib/mh/Rmail.OkDests";
#endif	MHMTS
...
#ifdef	SENDMTS
char   *hostable = "/usr/local/lib/mh/hosts";
...
char    *popbbhost = "";
char    *popbbuser = "";
char    *popbblist = "/usr/local/lib/mh/hosts.popbb";
#endif	BPOP


/* MailDelivery */

char   *maildelivery = "/usr/local/lib/mh/maildelivery";
...
/* customize the MTS settings for MH by reading /usr/local/lib/mh/mtstailor */
