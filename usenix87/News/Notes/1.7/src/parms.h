...
#define		DFLTED "/usr/bin/vi"			/* default editor */
#define		SEQFILE "Dflt-Seq"			/* file in MSTDIR */
#define		DFLTSEQ "general"		/* unspecified NFSEQ */
...
#define		SUPERMAILER	"/usr/bin/mailx"	/* is a smart mailer */
#define		PAGER	"/usr/local/bin/less"		/* pg/more default */
#define		WRITE	"/usr/local/bin/talk"		/* user-user communication */
...
#define	FULLDOMAIN	"plus5.com"			/* local domain */
