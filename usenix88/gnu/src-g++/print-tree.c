...
#define DEFTREECODE_X(SYM, NAME, TYPE, LEN, ERR_NAME) NAME,
#define DEFTREECODE_XY(SYM, NAME, TYPE, LEN, ERR_NAME, ASG_ERR_NAME) NAME,
...
/* Names of tree components' names for error reporting.
   Used for printing out the tree and error messages.  */
#define DEFTREECODE(SYM, NAME, TYPE, LEN) "help!",
#define DEFTREECODE_X(SYM, NAME, TYPE, LEN, ERR_NAME) ERR_NAME,
#define DEFTREECODE_XY(SYM, NAME, TYPE, LEN, ERR_NAME, ASG_ERR_NAME) ERR_NAME,

char *tree_code_err_name[] = {
#include "tree.def"
};
#undef DEFTREECODE
#undef DEFTREECODE_X
...
#define DEFTREECODE(SYM, NAME, TYPE, LEN) "help!",
#define DEFTREECODE_X(SYM, NAME, TYPE, LEN, ERR_NAME) "help!",
#define DEFTREECODE_XY(SYM, NAME, TYPE, LEN, ERR_NAME, ASG_ERR_NAME) ASG_ERR_NAME,

char *tree_code_err_asg_name[] = {
#include "tree.def"
};
#undef DEFTREECODE
#undef DEFTREECODE_X
