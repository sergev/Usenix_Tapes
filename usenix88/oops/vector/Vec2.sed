...
s/^friend[	 ][	 ]*void[	 ][	 ]*operator\([-+*/%&|^]=\)(\([A-Z][a-z]*\)Slice&,const \2Slice&);.*/FRIEND_TYPESlice_ASNOP_TYPESlice(\2,\1)/p
s/^friend[	 ][	 ]*void[	 ][	 ]*operator\([-+*/%&|^]=\)(\([A-Z][a-z]*\)Slice&,[a-z]*);.*/FRIEND_TYPESlice_ASNOP_TYPE(\2,\1)/p
