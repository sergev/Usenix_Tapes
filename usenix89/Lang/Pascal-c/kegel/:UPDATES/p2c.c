/*----------------------------------------------------------------------
  ...
  Revisions:
    ...
    Version 1.2 Dan Kegel 15 Mar 87  Made it work on Sun workstation.  
    Ripped out translations that hurt translation of a large Turbo program.
    Added proc.c, flat/recursive-descent parser.

    Version 1.3 Dan Kegel 16 Apr 87  Fixed bug in proc.c,
    added makefile.dos for MS-DOS people.
----------------------------------------------------------------------*/
