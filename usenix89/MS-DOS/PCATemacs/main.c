 ...
 *      - Ported to Amiga.
 *
 * 2.1  Curt Jutzi, March-10-85
 *	- Added the Meta-X command interface to meta.c
 *	- changed the search to be case sensative
 *	- added  "replace-string" META.c
 *	- added  "query-replace"  META.c
 *	- added  "addbufftext"    BUFFER.c
 *	- Help menue for Meta-X commands if miss typed (used system routines)
 *
 */
#include        <stdio.h>
#include        "ed.h"
