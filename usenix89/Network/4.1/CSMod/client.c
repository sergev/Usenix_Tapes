 ...
 */
#ifndef lint
char sccsid[] = "@(#) $Header: client.c,v 1.2 86/05/16 14:16:22 sob Exp $";
#endif
...
# ifdef OLDTCP
	sock = socket(SOCK_STREAM, 0, &sin, 0);
# else
...
#endif
#ifdef OLDTCP
	if (connect(sock, (char *)&sin) < 0) {
#else 
	if (connect(sock, (char *)&sin, sizeof (sin), 0) < 0) {
#endif 
