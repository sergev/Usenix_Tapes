...
#define DFLTNAME "/dev/stdin"	/* default input filename (for errors) */
#define DFLTPAT	 "^From "	/* default pattern for where to split lines */
...
#define DFLTOUTNAME	"split:%06.d"	/* o/p file name format */
